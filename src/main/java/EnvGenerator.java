...
public class EnvGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int stateCount = Globals.profiler.getStateCountValue();

        environment.setStates(new ArrayList<>());
        environment.setPitfallCount(Globals.profiler.getPitfallCountValue());
        environment.setAgentsCount(Globals.profiler.getAgentsCountValue());
        ...
        if (pitfallCountValue > 0) {
            ...
            for (; i <= pitfallCountValue && i < stateCount; ) {
                ...
                if (!environment.getStates().get(stateId).isIsPitfall()) {
                    ...
                    environment.getStates().get(stateId).setCapacity(Globals.profiler.getAgentsCountValue());
                    i++;
                }
            }
        ...
        for (int i = 0; i < stateCount; i++) {
            ...
            int targetCount = Globals.profiler.getStateTargetCountValue();
